...
export default function DashboardPage({ user, initialTab, onLogout, onNavigate }: DashboardPageProps) {
  ...
  useEffect(() => {
    if (initialTab && initialTab !== ("advertiser" as any)) {
    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col md:flex-row relative" id="dashboard_root">
      ...
      `} id="dashboard_sidebar">
        ...
        <div className="p-6 border-b border-slate-800/80 flex items-center justify-between">
          <div className="flex items-center gap-3 cursor-pointer" onClick={() => onNavigate("home")}>
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[8px] uppercase tracking-widest font-extrabold mt-1 leading-none text-slate-500">
                Publisher Dashboard
              </span>
            </div>
          </div>
        ...
        <div className="p-4 bg-slate-950/60 border-b border-slate-800/80 flex items-center gap-3">
          <div className="w-10 h-10 rounded-full flex items-center justify-center font-extrabold text-white shrink-0 bg-indigo-600">
